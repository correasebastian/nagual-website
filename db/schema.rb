...
ActiveRecord::Schema.define(version: 20_170_117_150_519) do
  ...
  create_table 'custom_attributes', force: :cascade do |t|
    ...
    t.index %w(product_id name), name: 'index_custom_attributes_on_product_id_and_name', unique: true, using: :btree
  ...
  create_table 'variation_attribute_values', force: :cascade do |t|
    ...
    t.index %w(variation_attribute_id value), name: 'var_attr_vals_index', unique: true, using: :btree
  ...
  create_table 'variation_attributes', force: :cascade do |t|
    ...
    t.string 'variation_attribute_id'
    t.string 'display_value'
    t.index %w(product_id attribute_id), name: 'index_variation_attributes_on_product_id_and_attribute_id', unique: true, using: :btree
